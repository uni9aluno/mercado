...
export default function App() {
  ...
  return (
    <div className="mx-auto flex min-h-full max-w-7xl md:gap-6 md:p-4">
      ...
      {/* bottom bar — mobile */}
      <nav className="app-bottom-nav fixed inset-x-0 bottom-0 z-30 flex border-t border-gray-200 bg-white md:hidden">
        {mobileRoutes.map((r) => {
          const Ico = Icon[r.icon];
          const on = r.id === tab;
          return (
            <button
              ...
              onClick={() => ir(r.id)}
              className={
                "flex min-h-14 flex-1 flex-col items-center justify-center gap-0.5 py-2 text-[10px] " +
